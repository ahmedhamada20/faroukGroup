...
<div class="left side-menu">
    ...
    <div class="left-side-logo d-block d-lg-none">
        <div class="text-center">
            ...
            <a href="{{route('/dashboard/customer')}}" class="logo"><img src="{{asset('front/user/assets/images/logo_dark.png')}}" height="20" alt="logo"></a>
        </div>
    </div>
    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                <li class="menu-title">مرحبا بك في لوحه تحكمك</li>

                <li>
                    <a href="{{route('/dashboard/customer')}}" class="waves-effect">
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-briefcase"></i> <span> تواصل معانا </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="list-unstyled">
                        <li><a href="{{route('tickets.index')}}">فتح تذكره جديده</a></li>
                        <li><a href="ui-badge.html">متابعه حالات التذكره</a></li>
                    </ul>
                </li>

...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ route('dashboard') }}"><img
                src="{{URL::asset('admin/assets/img/brand/logo.png')}}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ route('dashboard') }}"><img
                src="{{URL::asset('admin/assets/img/brand/logo-white.png')}}" class="main-logo dark-theme"
                alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ route('dashboard') }}"><img
                src="{{URL::asset('admin/assets/img/brand/favicon.png')}}" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ route('dashboard') }}"><img
                src="{{URL::asset('admin/assets/img/brand/favicon-white.png')}}" class="logo-icon dark-theme"
                alt="logo"></a>
    </div>
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{URL::asset('admin/assets/img/faces/6.jpg')}}"><span
        ...
        <ul class="side-menu">
            @can('dashboard')
            <li class="side-item side-item-category">الصفحه الرئسيه</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard') }}">
                    ...
                    <span class="side-menu__label">الصفحه الرئسيه</span></a>
            </li>
            @endcan

            @can('setting')
            <li class="side-item side-item-category">الاعدادات الرئسيه</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('setting') }}">
                    ...
                    <span class="side-menu__label">الاعدادات الرئسيه</span></a>
            </li>
            @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">عمليات التواصل</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('customers.index') }}">جميع العملاء</a></li>
                    <li><a class="slide-item" href="{{ route('customers.waiting') }}">عملاء في انتظار الموافقه</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">المستخدمين والصلاحيات</span><i
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">من نحن</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('aboutUs.index') }}">من نحن</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('product.index') }}">المنتجات</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">معرض الصور</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('gallery.index') }}">معرض الصور</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">المدونات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('blog.index') }}">المدونات</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الاسئله الشائعة</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('question.index') }}">الاسئله الشائعة</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الاكثر مبيعا</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('bestSeller.index') }}">الاكثر مبيعا</a></li>
                </ul>
            </li>
            @endcan --}}
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الاحداث</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">السليدر</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('slider.index') }}">السليدر</a></li>
                </ul>
            </li>
            @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الاخبار</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الاعلانات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الباقات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('packages.index') }}">الباقات</a></li>
                </ul>
            </li>
            @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">حصص اون لاين</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

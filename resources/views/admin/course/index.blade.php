...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">  صفحات الخدمات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/   صفحات الخدمات</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col">
                            @can('create-course')
                            <a href="{{route('course.create')}}" class="btn btn-success">اضافه جديده</a>
                            @endcan
                        </div>
                    </div>

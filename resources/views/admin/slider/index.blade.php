...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> الاحداث</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/   الاحداث</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col">
                            @can('create-slider')
                                <a href="{{route('slider.create')}}" class="btn btn-success">اضافه جديده</a>
                            @endcan
                        </div>
                    </div>
                            ...
                            @forelse($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @can('edit-slider')
                                            <a href="{{route('slider.edit',$row->id)}}" class="btn btn-success btn-sm"><i
